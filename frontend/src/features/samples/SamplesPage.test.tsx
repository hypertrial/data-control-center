...
const h = vi.hoisted(() => ({ getSample: vi.fn(), fetchDatasetProfile: vi.fn(), fetchDatasetProfileOnce: vi.fn() }))
...
describe('SamplesPage', () => {
  beforeEach(() => {
    ...
    h.fetchDatasetProfileOnce.mockResolvedValue(mkProfile({ column_profiles: [] }))
  })
